...
class HomeNutritionistScreen extends StatelessWidget {
  final Utilisateur utilisateur;
  const HomeNutritionistScreen({Key? key, required this.utilisateur})
    : super(key: key);
                            ...
                            child: ListView.separated(
                              ...
                              itemBuilder: (ctx, idx) {
                                return ListTile(
                                  ...
                                  title: Text('Patient ${idx + 1}'),
                                  subtitle: const Text(
                                    'Dernière consultation: 3 jours',
                                  ),
                                  trailing: IconButton(
